...
if(NOT EXISTS ${LIBUBOOTENV_SOURCE_DIR}/CMakeLists.txt)
  ...
  message(
    STATUS "GIT_CLONE_LIBUBOOTENV_RESULT: ${GIT_CLONE_LIBUBOOTENV_RESULT}")
endif()
...
set(libubootenv_static_LIBRARY
    ${install_dir}/lib/liblibubootenv${CMAKE_STATIC_LIBRARY_SUFFIX})
set(libubootenv_shared_LIBRARY
    ${install_dir}/bin/liblibubootenv${CMAKE_SHARED_LIBRARY_SUFFIX})
message(STATUS "libubootenv_shared_LIBRARY: ${libubootenv_shared_LIBRARY}")

# libubootenv-static
add_library(libubootenv-static STATIC IMPORTED)
add_dependencies(libubootenv-static libubootenv-project)
set_property(TARGET libubootenv-static
             PROPERTY IMPORTED_LOCATION ${libubootenv_static_LIBRARY})
set_property(TARGET libubootenv-static
             PROPERTY INTERFACE_INCLUDE_DIRECTORIES ${libubootenv_INCLUDE_DIR})

# libubootenv-shared
add_library(libubootenv-shared SHARED IMPORTED)
add_dependencies(libubootenv-shared libubootenv-project)
set_property(TARGET libubootenv-shared
             PROPERTY IMPORTED_LOCATION ${libubootenv_shared_LIBRARY})
set_property(TARGET libubootenv-shared
             PROPERTY INTERFACE_INCLUDE_DIRECTORIES ${libubootenv_INCLUDE_DIR})
