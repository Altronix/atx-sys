...
if(NOT EXISTS ${LIBUBOOTENV_SOURCE_DIR}/CMakeLists.txt)
  execute_process(
    COMMAND ${GIT_EXECUTABLE} submodule update --init external/libubootenv
...
set(libubootenv_static_LIBRARY ${install_dir}/lib/liblibubootenv${CMAKE_STATIC_LIBRARY_SUFFIX})
set(libubootenv_shared_LIBRARY ${install_dir}/bin/liblibubootenv${CMAKE_SHARED_LIBRARY_SUFFIX})
