...
mongoose_parser_parse(http_parser* parser, const char* data, uint32_t len)
{
    ...
    if (parser->type == HTTP_RESPONSE) {
        ...
        ((mongoose_mock_event*)parser->data)->message.message.p = data;
        ((mongoose_mock_event*)parser->data)->message.message.len = len;
        ((mongoose_mock_event*)parser->data)->message.method.p = data;
        ((mongoose_mock_event*)parser->data)->message.method.len = space - data;
    }
...
{
    mongoose_mock_event* req = p->data;
